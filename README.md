...
=======
### 5. INCANTO GitHub Vibe Coding AI Suite
* **Opis:** Działająca w przeglądarce suite deweloperska Vibe Coding AI pozwalająca na generowanie kodu HTML/CSS/JS w języku naturalnym, podgląd w czasie rzeczywistym i bezpośredni commit & push do repozytorium GitHub za pomocą GitHub REST API.
* **Kluczowe zalety:**
  * **Pełna integracja z GitHub API:** publikacja wygenerowanego kodu bez potrzeby używania lokalnego gita czy terminala.
  * **Szybki podgląd w iframe:** natychmiastowe testowanie aplikacji na żywo.
  * **Gotowy projekt Vercel (`incanto-vibe-coder`):** bezpośrednie powiązanie z repozytorium `Paparara1/Incanto`.
* **Folder projektu:** `/vibe-coder/`
* **Uruchomienie skryptem:** `./scripts/launch-vibe-coder.sh`

### 6. IrisVerify ID — React Biometric ID SPA
>>>>>>> feat/incanto-mobile-ai-pwa-transformers-biometrics-13908196613832524937
...
=======
### 7. IrisVault — Cyberpunk Biometric Eye-Scan Wallet
>>>>>>> feat/incanto-mobile-ai-pwa-transformers-biometrics-13908196613832524937
...
=======
  * **Interaktywne Modale:** w fully działające i walidowane formularze Send (Wyślij) i Receive (Odbierz). Proces wysyłki wymaga dodatkowej autoryzacji skanem oka i automatycznie aktualizuje stan portfela oraz dodaje transakcję do historii transakcji!
>>>>>>> feat/incanto-mobile-ai-pwa-transformers-biometrics-13908196613832524937
...
=======
### 💻 1. Uruchomienie IrisVault, Kobalt AI Builder i Vibe Coder (Najprostsza ścieżka)
Te projekty nie wymagają skomplikowanej kompilacji!
...
* **Kobalt AI Builder:** Wejdź do `/kobalt-html`, otwórz `index.html` w przeglądarce, wejdź w ustawienia (ikona zębatki), podaj swój własny klucz API (Claude, OpenAI lub Mistral) i zacznij tworzyć aplikacje!
* **INCANTO Vibe Coder:** Uruchom `./scripts/launch-vibe-coder.sh` lub otwórz `/vibe-coder/index.html` bezpośrednio w przeglądarce. Wdrożenie na Vercel z repozytorium `Paparara1/Incanto`: zobacz `docs/MOBILE_VERCEL_DEPLOY.md`.
>>>>>>> feat/incanto-mobile-ai-pwa-transformers-biometrics-13908196613832524937
