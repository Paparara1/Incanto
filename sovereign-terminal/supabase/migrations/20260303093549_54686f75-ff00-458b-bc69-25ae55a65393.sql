...
CREATE TABLE public.agents (
  ...
  type TEXT NOT NULL DEFAULT 'przyjaciel',
...
-- Helper function for message ownership
...
CREATE POLICY "Users can create own messages" ON public.messages FOR INSERT WITH CHECK (public.is_owner_of_conversation(conversation_id));
CREATE POLICY "Users can update own messages" ON public.messages FOR UPDATE USING (public.is_owner_of_conversation(conversation_id));
